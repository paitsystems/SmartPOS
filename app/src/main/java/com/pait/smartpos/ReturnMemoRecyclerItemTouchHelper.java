...
public class ReturnMemoRecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {

    private RecyclerItemTouchHelperListener listener;

    public ReturnMemoRecyclerItemTouchHelper(int dragDirs, int swipeDirs, RecyclerItemTouchHelperListener listener) {
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView,
        ...
        final View foregroundView = ((ReturnMemoRecyclerAdapter.ProductViewHolder) viewHolder).viewForeground;
        getDefaultUIUtil().onDraw(c, recyclerView, foregroundView, dX, dY,actionState, isCurrentlyActive);

        final View delbgView = ((ReturnMemoRecyclerAdapter.ProductViewHolder) viewHolder).viewBackground;
        if (dX>0){
